#!/bin/bash
#SBATCH --job-name=finetune_no_we_flowers
...
SAVE_PATH="ckpt/clean/finetune_no_we/trained/DTD_trained/MNIST_trained/EuroSAT_trained/Flowers_trained"

PREV_LOAD_PATH="ckpt/clean/finetune_no_we/trained/DTD_trained/MNIST_trained/EuroSAT_trained/EuroSAT.pth"
