#!/bin/bash
#SBATCH --job-name=un_finetune_no_we_flowers
#SBATCH --time=01:40:00            # max time
...
SAVE_PATH="ckpt/clean/finetune_no_we/untrained/DTD_untrained/MNIST_untrained/EuroSAT_untrained/Flowers_untrained"

PREV_LOAD_PATH="ckpt/clean/finetune_no_we/untrained/DTD_untrained/MNIST_untrained/EuroSAT_untrained/EuroSAT.pth"
