...
SAVE_PATH="ckpt/clean/zscl2/trained/DTD_trained/MNIST_trained/EuroSAT_trained/Flowers_trained"

PREV_LOAD_PATH="ckpt/clean/zscl2/trained/DTD_trained/MNIST_trained/EuroSAT_trained/EuroSAT.pth"
