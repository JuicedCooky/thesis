...
SAVE_PATH="ckpt/clean/finetune_only/DTD_untrained/MNIST_untrained/EuroSAT_untrained/Flowers_untrained"

PREV_LOAD_PATH="ckpt/clean/finetune_only/DTD_untrained/MNIST_untrained/EuroSAT_untrained/EuroSAT.pth"
