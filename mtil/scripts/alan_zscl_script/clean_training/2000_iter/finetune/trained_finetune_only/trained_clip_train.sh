#!/bin/bash
#SBATCH --job-name=trained_eurosat
...
SAVE_PATH="ckpt/clean/finetune_only/DTD_trained/MNIST_trained/EuroSAT_trained/Flowers_trained"

PREV_LOAD_PATH="ckpt/clean/finetune_only/DTD_trained/MNIST_trained/EuroSAT_trained/EuroSAT.pth"
