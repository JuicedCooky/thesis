#!/bin/bash
#SBATCH --job-name=fre_zscl_flowers
...
SAVE_PATH="ckpt/clean/frozen_zscl/trained/DTD_trained/MNIST_trained/EuroSAT_trained/Flowers_trained"

PREV_LOAD_PATH="ckpt/clean/frozen_zscl/trained/DTD_trained/MNIST_trained/EuroSAT_trained/EuroSAT.pth"
