#!/bin/bash
#SBATCH --job-name=un_pure_finetune_flowers
...
SAVE_PATH="ckpt/clean/pure_finetune/untrained/DTD_untrained/MNIST_untrained/EuroSAT_untrained/Flowers_untrained"

PREV_LOAD_PATH="ckpt/clean/pure_finetune/untrained/DTD_untrained/MNIST_untrained/EuroSAT_untrained/EuroSAT.pth"
