#!/bin/bash
#SBATCH --job-name=trained_flowers
...
SAVE_PATH="ckpt/clean/zscl/DTD_trained/MNIST_trained/EuroSAT_trained/Flowers_trained"

PREV_LOAD_PATH="ckpt/clean/zscl/DTD_trained/MNIST_trained/EuroSAT_trained/EuroSAT.pth"
