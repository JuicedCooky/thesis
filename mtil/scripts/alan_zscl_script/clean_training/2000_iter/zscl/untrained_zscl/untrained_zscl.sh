#!/bin/bash
#SBATCH --job-name=un_zscl_flowers
...
SAVE_PATH="ckpt/clean/zscl/untrained/DTD_untrained/MNIST_untrained/EuroSAT_untrained/Flowers_untrained"

PREV_LOAD_PATH="ckpt/clean/zscl/untrained/DTD_untrained/MNIST_untrained/EuroSAT_untrained/EuroSAT.pth"
