#!/bin/bash
#SBATCH --job-name=un_freeze_mnist
...
SAVE_PATH="ckpt/clean/frozen/untrained/DTD_untrained/MNIST_untrained"

PREV_LOAD_PATH="ckpt/clean/frozen/untrained/DTD_untrained/DTD.pth"
