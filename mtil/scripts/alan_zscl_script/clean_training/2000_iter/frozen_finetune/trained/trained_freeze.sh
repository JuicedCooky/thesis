#!/bin/bash
#SBATCH --job-name=fre_finetune_flowers
...
SAVE_PATH="ckpt/clean/frozen_finetune/trained/DTD_trained/MNIST_trained/EuroSAT_trained/Flowers_trained"

PREV_LOAD_PATH="ckpt/clean/frozen_finetune/trained/DTD_trained/MNIST_trained/EuroSAT_trained/EuroSAT.pth"
