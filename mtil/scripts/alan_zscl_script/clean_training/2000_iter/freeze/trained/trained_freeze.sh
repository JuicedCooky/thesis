#!/bin/bash
#SBATCH --job-name=Flowers_trained
#SBATCH --time=01:20:00            # max time
...
SAVE_PATH="ckpt/clean/frozen/DTD_trained/MNIST_trained/EuroSAT_trained/Flowers_trained"

PREV_LOAD_PATH="ckpt/clean/frozen/DTD_trained/MNIST_trained/EuroSAT_trained/EuroSAT.pth"
