...
SAVE_PATH="ckpt/clean/5000_iter/finetune/trained/DTD_trained/MNIST_trained"

PREV_LOAD_PATH="ckpt/clean/5000_iter/finetune/trained/DTD_trained/DTD.pth"
