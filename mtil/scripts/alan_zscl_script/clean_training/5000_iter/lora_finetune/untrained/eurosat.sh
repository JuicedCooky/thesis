#!/bin/bash
#SBATCH --job-name=un_zscl_eurosat
...
SAVE_PATH="ckpt/clean/zscl2/untrained/DTD_untrained/MNIST_untrained/EuroSAT_untrained"

PREV_LOAD_PATH="ckpt/clean/zscl2/untrained/DTD_untrained/MNIST_untrained/MNIST.pth"
PREV_GRADIENT_PATH="ckpt/clean/zscl2/untrained/DTD_untrained/MNIST_untrained/grad_MNIST.pth"
