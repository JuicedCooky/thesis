...
FOLDER_PATH="ckpt/clean/5000_iter/share_lora_finetune_continue"
ITERATIONS=5000
JOB_NAME="share_lora_finetune"
...
TRAIN_CMD=(
    ...
    "${SCRIPT_DIR}/train.sh"
    "DTD" #arg1: dataset
    "${FOLDER_PATH}/base" #arg2: save_path
    "" #arg3: prev model path
    "0" #arg4: iterations
    "${PREV_GRADIENT_PATH}" #arg5: gradient path 
)
