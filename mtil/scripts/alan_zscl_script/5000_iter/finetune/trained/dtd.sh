#!/bin/bash
#SBATCH --job-name=fine_dtd_continue
...
SAVE_PATH="ckpt/clean/gradient_zscl/trained/DTD_trained/MNIST_trained/Flowers_trained/EuroSAT_trained"

PREV_LOAD_PATH="ckpt/clean/gradient_zscl/trained/DTD_trained/MNIST_trained/Flowers_trained/Flowers.dtd"
