#!/bin/bash
#SBATCH --job-name=lora_finetune_mnist
...
SAVE_PATH="ckpt/clean/5000_iter/lora_finetune/trained/DTD_trained/MNIST_trained"
PREV_LOAD_PATH="ckpt/clean/5000_iter/lora_finetune/trained/DTD_trained/DTD.pth"
