#!/bin/bash
#SBATCH --job-name=un_zscl_f
#SBATCH --time=01:45:00            # max time
...
SAVE_PATH="ckpt/clean/zscl2/untrained/DTD_untrained/MNIST_untrained/EuroSAT_untrained/Flowers_untrained"

PREV_LOAD_PATH="ckpt/clean/zscl2/untrained/DTD_untrained/MNIST_untrained/EuroSAT_untrained/EuroSAT.pth"

PREV_GRADIENT_PATH="ckpt/clean/zscl2/untrained/DTD_untrained/MNIST_untrained/EuroSAT_untrained/grad_EuroSAT.pth"
