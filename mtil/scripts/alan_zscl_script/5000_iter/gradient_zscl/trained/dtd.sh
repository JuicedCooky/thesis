#!/bin/bash
#SBATCH --job-name=gradient_zscl_dtd
#SBATCH --time=01:30:00            # max time
...
SAVE_PATH="ckpt/clean/5000_iter/gradient_zscl/trained/DTD_trained"

PREV_LOAD_PATH="ckpt/clean/5000_iter/gradient_zscl/trained/DTD_trained/DTD.pth"
PREV_GRADIENT_PATH="ckpt/clean/5000_iter/gradient_zscl/trained/DTD_trained/grad_DTD.pth"
