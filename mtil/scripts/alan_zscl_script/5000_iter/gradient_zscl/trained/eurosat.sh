#!/bin/bash
#SBATCH --job-name=gradient_zscl_eurosat
...
SAVE_PATH="ckpt/clean/gradient_zscl/trained/DTD_trained/MNIST_trained/EuroSAT_trained2"

PREV_LOAD_PATH="ckpt/clean/gradient_zscl/trained/DTD_trained/MNIST_trained/MNIST.pth"
PREV_GRADIENT_PATH="ckpt/clean/gradient_zscl/trained/DTD_trained/MNIST_trained/grad_MNIST.pth"
